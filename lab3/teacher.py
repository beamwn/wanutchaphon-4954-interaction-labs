class Teacher:
    def __init__(self, name, office_no, reseach_work, *course_work):
        self.name = name
        self.office_no = office_no
        self.reseach_work = reseach_work
    ...
    def print_research_work(self):
        print(f'{self.name} is doing reseach in these topic {self.course_work}')
